...
class GraphParam(unittest.TestCase):
    ...
    def test_pathlookup(self):
        ...
        self.assertEqual(bp, {'type': 'pathLookup', 'groupBy': 'siteName', 'protocol': 'tcp', 'ttl': 128,
                              'fragmentOffset': 0, 'securedPath': True, 'srcRegions': '.*', 'dstRegions': '.*',
    ...
    def test_multicast(self):
        ...
        self.assertEqual(m, {'type': 'pathLookup', 'groupBy': 'siteName', 'protocol': 'tcp', 'ttl': 128,
                             'fragmentOffset': 0, 'securedPath': True, 'srcRegions': '.*', 'dstRegions': '.*',
                             'l4Options': {'srcPorts': '1024-65535', 'dstPorts': '80,443', 'flags': []},
                             'otherOptions': {'applications': '.*', 'tracked': False}, 'firstHopAlgorithm':
                                 {'type': 'automatic'}, 'pathLookupType': 'multicast', 'group': '2.2.2.2',
                             'source': '1.1.1.1', 'receiver': '3.3.3.3'})
    ...
    def test_unicast(self):
        ...
        self.assertEqual(u, {'type': 'pathLookup', 'groupBy': 'siteName', 'protocol': 'tcp', 'ttl': 128,
                             'fragmentOffset': 0, 'securedPath': True, 'srcRegions': '.*', 'dstRegions': '.*',
                             'l4Options': {'srcPorts': '1024-65535', 'dstPorts': '80,443', 'flags': []},
                             'otherOptions': {'applications': '.*', 'tracked': False}, 'firstHopAlgorithm':
                                 {'type': 'automatic'}, 'pathLookupType': 'unicast', 'networkMode': False,
                             'startingPoint': '1.1.1.1/32', 'destinationPoint': '2.2.2.2/32'})
    ...
    def test_host2gw(self):
        ...
        self.assertEqual(h, {'pathLookupType': 'hostToDefaultGW', 'type': 'pathLookup', 'groupBy':
            'siteName', 'startingPoint': '1.1.1.1', 'vrf': 'mgmt'})
