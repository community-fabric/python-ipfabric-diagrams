...
VALID_PROTOCOL_LABELS = dict(
    ...
    ospf=Protocol(name='ospf', labels=[PROTOCOL, INT_NAME, IP_ADDR, SUBNET, Label(name='area', center=False),
                                       Label(name='cost', center=False)]),
    ospfv3=Protocol(name='ospfv3', labels=[PROTOCOL, INT_NAME, IP_ADDR, SUBNET, Label(name='area', center=False),
                                           Label(name='cost', center=False)]),
...
VALID_DEV_TYPES = ["aciLeaf", "aciSpine", "ap", "cloud", "cloudInstance", "cloudInternetGw", "cloudLoadBalancer",
                   "cloudNatGw", "cloudRouter", "cloudTransitHub", "cloudVpnGw", "fex", "fw", "host", "l3switch",
                   "lb", "nx7000", "phone", "router", "securityManagement", "switch", "transit", "unknown", "vgw",
                   "waas", "wlc"]
